...
def main(_):
    ...
    model = ResNet18FeatureExtractor(prertained_checkpoint_path=str(resnet_checkpoint))
    ...
    tsne_results = TSNE(n_components=2, init="pca", perplexity=10.0).fit_transform(
        all_features
    )
